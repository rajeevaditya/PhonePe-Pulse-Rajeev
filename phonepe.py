...
with st.sidebar:
    main = option_menu(None, ["Home", 'Visualization'],icons=['house', 'bank'], menu_icon="cast")
  ...
  # navigation menu
    with st.sidebar:
        analyser = option_menu(
            menu_title=None,
            options=["High Level Analysis","Transaction","User"],    # "REGISTER USER","APP OPENED USER"
            icons=["pin-map", "person"],  # https://icons.getbootstrap.com/
        )

    image2 = Image.open("images.jpg")
    st.sidebar.image(image2, width=310)

    if analyser == "High Level Analysis":
    #@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ INDIA MAP ANALYSIS @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        #st.image("download.jpg", width=50)
        st.write('# :red[GEOGRAPHICAL ANALYSIS]')
    ...
    if analyser == "User":
        ...
        tab1, tab2, tab3, tab4 = st.tabs(["STATE ANALYSIS", "DISTRICT ANALYSIS","DEVICE ANALYSIS","OVERALL ANALYSIS"])
        ...
        # ===================================================U OVERALL ANALYSIS ====================================================
            ...
            with tab4:
                ...
                d = years_Table.sort_values(by=['Registered_Users'])
                fig1= px.bar(d, x='year', y='Registered_Users',color="Registered_Users",
                        title='Registered_Users by Year',
                        color_continuous_scale="balance",)  
                
                
                fig2= px.bar(d, x='year', y='AppOpenings',color="AppOpenings",
                        title='AppOpenings by Year',
                        color_continuous_scale="balance",)  
